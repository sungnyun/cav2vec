...
class OverrideConfig(FairseqDataclass):
    ...
    visual_corruption_prob: float = field(default=0., metadata={'help': 'visual corruption probability'})
    ...
    visual_noise: bool = field(default=False, metadata={'help': 'use noise in visual input'})
...
def _main(cfg, output_file):
    ...
    task.cfg.noise_prob_heavy = cfg.override.noise_prob_heavy
    ...
    task.cfg.visual_corruption_prob = cfg.override.visual_corruption_prob
    task.cfg.visual_corruption_max_freq = cfg.override.visual_corruption_max_freq
    task.cfg.visual_occ_type = cfg.override.visual_occ_type
    task.cfg.visual_noise = cfg.override.visual_noise
    task.cfg.output_clean = False
